...
WebUI.click(findTestObject('Object Repository/MELI/span_Consulta Envio_ui-icon ui-icon-closethick'))

WebUI.click(findTestObject('Object Repository/MELI/span_Atencin Cliente (2)'))

WebUI.click(findTestObject('Object Repository/MELI/span_Distribucion'))

WebUI.click(findTestObject('Object Repository/MELI/span_Siniestrar Envo'))

WebUI.setText(findTestObject('Object Repository/MELI/input_PISTOLEAR TRACKING_frmSiniestrarcodigoBarras'), '02400000892')

WebUI.click(findTestObject('Object Repository/MELI/span_Seleccionar_ui-icon ui-icon-triangle-1-s ui-c'))

WebUI.setText(findTestObject('Object Repository/MELI/input_MOTIVOS_frmObservacionmotivos_focus'), 'c')

WebUI.click(findTestObject('Object Repository/MELI/li_ENVO CONFISCADO'))

WebUI.click(findTestObject('Object Repository/MELI/span_GRABAR'))

WebUI.verifyElementText(findTestObject('Object Repository/MELI/span_Grabado Exitoso'), 'Grabado Exitoso.')
...
WebUI.verifyElementText(findTestObject('Object Repository/MELI/td_SINIESTRADO'), 'SINIESTRADO')
